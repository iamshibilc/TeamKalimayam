...
banner() {
printf "\e[1;30m        WELCOME  \n"
printf "\e[1;30m  CODED BY SIMZEOVER \n"
printf " \n"
printf "\e[1;31m ███████  ███████  ███████  ██████████████\n"
printf "\e[1;30m   ██     ██       ██   ██  ██    ██    ██\n"
printf "\e[1;30m   ██     █████    ███████  ██    ██    ██\n"
...
if [[ $user == "" ]]; then
printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m Login\e[0m\n"
read -p $'\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m Username: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m COOKIES FOUND FOR USER\e[0m\e[1;31m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m USE IT?\e[0m\e[1;31m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m USING SAVED CREDENTAILS\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
read -s -p $'\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m Password: \e[0m' pass
printf "\n"
...
printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m] TRYING TO LOGIN AS\e[0m\e[1;31m %s\e[0m\n" $user
IFS=$'\n'
...
if [[ $var == "challenge" ]]; then printf "\e[1;36m\n[!] Challenge required\n" ; exit 1; elif [[ $var == "logged_in_user" ]]; then printf "\e[1;32m \n[M] LOGIN SUCCESSFULLY\n" ; elif [[ $var == "PLEASE WAIT" ]]; then echo "PLEASE WAIT"; fi; 
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Generating image list\n"
...
count_img=0
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Total images:\e[0m\e[1;36m %s\e[0m \n" $tot_img

for img in $(cat links); do

let count_img++
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Downloading image\e[0m\e[1;36m %s/%s\e[0m " $count_img $tot_img
wget $img -O $user/images/image$count_img.jpg > /dev/null 2>&1
printf "\e[1;36mDONE!\n\e[0m"
done
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Saved:\e[0m\e[1;36m %s/images/\e[0m\n" $user
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Total Videos:\e[0m\e[1;36m %s\e[0m\n" $tot_vid
for link in $(cat vid_$user); do
let count++
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Downloading video\e[0m\e[1;36m %s/%s\e[0m " $count $tot_vid
printf "\e[1;36mDONE!\n\e[0m"
wget $link -O $user/videos/video$count.mp4 > /dev/null 2>&1
done

printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Saved:\e[0m\e[1;36m %s/videos/\e[0m\n" $user 
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Total Following:\e[0m\e[1;36m %s\e[0m\n" $tot_following
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Saved:\e[0m\e[1;36m %s.following_backup\e[0m\n" $user_account
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Creating followers list for user\e[0m \e[1;36m%s\e[0m\n" $user_account
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Please wait...\e[0m\n"
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Total Followers:\e[0m\e[1;36m %s\e[0m\n" $tot_follow
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Saved:\e[0m\e[1;36m %s.followers_backup\e[0m\n" $user_account
...
read -p $'\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Account (leave it blank to use your account): \e[0m' user_account
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Total Video Stories:\e[0m\e[1;36m %s\e[0m\n" $tot_vid
IFS=$'\n'
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Downloading Story Video\e[0m\e[1;36m %s/%s\e[0m " $count $tot_vid
printf "\e[1;36mDONE!\n\e[0m"
IFS=$'\n'
wget $link -O $user_account/story/story$count.mp4 > /dev/null 2>&1
done

printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Saved:\e[0m\e[1;36m %s/story/\e[0m\n" $user_account

#Story Image
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Total Image Stories:\e[0m\e[1;36m %s\e[0m\n" $tot_img

for link2 in $(cat $user_account.story_images); do
let count2++

printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Downloading Story Image\e[0m\e[1;93m %s/%s\e[0m " $count2 $tot_img
printf "\e[1;36mDONE!\n\e[0m"
IFS=$'\n'
...
printf "\e[1;30m[\e[0m\e[1;30mM\e[0m\e[1;30m]\e[0m\e[1;36m Preparing to unfollow all followers from \e[0m\e[1;36m%s ...\e[0m\n" $user_account
printf "\e[1;30m[\e[0m\e[1;30mM\e[0m\e[1;30m]\e[0m\e[1;36m Press \"Ctrl + c\" to stop...\e[0m\n"
sleep 4
while [[ true ]]; do
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$user_id'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Trying to unfollow %s ..." $unfollow_name
...
if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;36m [!] Error, stoping to prevent blocking\e[0m\n"
exit 1
else
printf "\e[1;36mOK\e[0m\n"
fi
...
printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m] STARTED TEAM KALIMAYAM \e[0m\n"
printf "\e[1;33m[\e[0m\e[1;33mM\e[0m\e[1;33m] PLEASE USE KALIMAYAM DP!  \e[0m\n"
printf "\e[1;31m[\e[0m\e[1;31mM\e[0m\e[1;31m]\e[0m\e[1;31m PRESS Ctrl + Z TO BOT STOP  \e[0m\n"
sleep 5
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;30m[\e[0m\e[1;30mM\e[0m\e[1;30m]\e[0m\e[1;30m RUNNING KALIMAYAM..."
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Last list found for user \e[0m\e[1;36m%s\e[0m\e[1;36m, creating a new and comparing it\e[0m\n" $user_account
total_followers
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Unfollowers:\e[0m\n"

grep -Fxv -f followers2.$user_account followers1.$user_account >> $user_account.unfollowers
printf "\e[1;36m\n"
cat $user_account.unfollowers
printf "\e[0m\n"
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Saved: \e[0m\e[1;36m%s.unfollowers\e[0m\n" $user_account
mv followers2.$user_account followers1.$user_account

else
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m No Unfollower\e[0m\n"
fi


else
#get  followers
printf "\e[1;36m[\e[0m\e[1;33m+\e[0m\e[1;36m]\e[0m\e[1;36m Creating followers list\e[0m\n"
total_followers
cp $user_account.followers_backup followers1.$user_account
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Saved!\e[0m\e[1;77m (followers1.%s)\e[0m\n" $user_account
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Please, run again to track unfollowers\e[0m\n"
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m %s\e[0m\e[1;36m account info:\e[0m\n" $user_account
cat $user_account/profile.info
grep -o 'https://[^ ]*.jpg[^\ ]*.' $user_account/profile.info | cut -d '"' -f1 | tr -d '\\' | uniq > $user_account/profile_pic


printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Downloading Profile Pictures...\e[0m"
count=0
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Saved:\e[0m\e[1;36m %s/\e[0m\n" $user_account

}

menu() {
printf "\n"
printf " \e[1;30m[\e[0m\e[1;30m01\e[0m\e[1;30m]\e[0m\e[1;30m START KALIMAYAM \e[0m\n"
printf " \e[1;30m[\e[0m\e[1;30m02\e[0m\e[1;30m]\e[0m\e[1;30m EXIT \e[0m\n"
printf "\n"


read -p $' \e[1;30m[\e[0m\e[1;30mM\e[0m\e[1;30m]\e[0m\e[1;30m >>> \e[0m' option
